...
public class CoolWeatherDB {
	...
	public void saveCounty(County county) {
		if (county != null) {
			...
			db.insert(TABLE_NAME_COUNTY, null, values);
		}
	}
	...
	public List<City> loadCities(int provinceId) {
		...
		Cursor cursor = db.query(TABLE_NAME_CITY, null, "province_id = ?", new String[] { String.valueOf(provinceId) }, null, null, null);
		if (cursor.moveToFirst()) {
			do {
				City city = new City();
	...
	public List<County> loadCounties(int cityId) {
		...
		Cursor cursor = db.query(TABLE_NAME_COUNTY, null, "city_id = ?", new String[] { String.valueOf(cityId) }, null, null, null);
		if (cursor.moveToFirst()) {
			do {
